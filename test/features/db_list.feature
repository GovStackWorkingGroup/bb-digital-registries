Feature: API endpoint allowing users to get information about Digital Registries databases.
  Request endpoint: GET /databases
    ...
    Scenario: The user is not able to receive information for Digital Registries databases because of  an empty value in the header
      ...
      Then The result of an operation to receive information about the databases of Digital Registers returns an error
    ...
    Scenario: The user is not able to receive information for Digital Registries databases because of not include header
      ...
      Then The operation result of receiving information about the databases of Digital Registries is an error
